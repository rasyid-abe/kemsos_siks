...
// show status 8a
class Verivali_grab_revoked extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_grab_revoked/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI GRAB REVOKED';
	...
	function get_show_data(){
		...
		$where = [];
		$where['md.stereotype'] = 'VERIVALI-GRAB-REVOKED';
