...
class Verivali_submited extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_submited/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI SUBMITTED';
		$data['grid']['link_data'] = $this->dir . "get_show_data";
		$data['grid']['table_title'] = 'VERIVALI SUBMITTED';
		$data['extra_script'] = '
			<script>
	...
	function get_show_data(){
		...
		$where = [];
		$where['md.stereotype'] = 'VERIVALI-SUBMITTED';
		...
		$params = [
			...
			'select' => '
				...
				l.village_name,
				r.icon',
			'order_by' => 'md.id_prelist ' . $input['sortorder'],
