...
class Verivali_supervisor_approved extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_supervisor_approved/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI SUPERVISOR APPROVED';
		$data['grid']['link_data'] = $this->dir . "get_show_data";
		$data['grid']['table_title'] = 'VERIVALI SUPERVISOR APPROVED';
		$data['extra_script'] = '
			<script>
