...
// show status 11a
class Verivali_submitted_reject extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_submitted_reject/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI-SUBMITTED-REJECT';
		$data['grid']['link_data'] = $this->dir . "get_show_data";
		$data['grid']['table_title'] = 'VERIVALI-SUBMITTED-REJECT';
		$data['extra_script'] = '
			<script>
	...
	function get_show_data(){
		...
		$where = [];
		$where['md.stereotype'] = 'VERIVALI-SUBMITTED-REJECT';
