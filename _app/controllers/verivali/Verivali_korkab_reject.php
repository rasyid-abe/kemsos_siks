...
// show status 12a
class Verivali_korkab_reject extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_korkab_reject/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI-KORKAB-REJECTED';
		$data['grid']['link_data'] = $this->dir . "get_show_data";
		$data['grid']['table_title'] = 'VERIVALI-KORKAB-REJECTED';
		$data['extra_script'] = '
			<script>
	...
	function get_show_data(){
		...
		$where = [];
		$where['md.stereotype'] = 'VERIVALI-KORKAB-REJECTED';
