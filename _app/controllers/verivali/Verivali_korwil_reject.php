...
// show status 13a
class Verivali_korwil_reject extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_korwil_reject/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI-KORWIL-REJECTED';
		$data['grid']['link_data'] = $this->dir . "get_show_data";
		$data['grid']['table_title'] = 'VERIVALI-KORWIL-REJECTED';
		$data['extra_script'] = '
			<script>
	...
	function get_show_data(){
		...
		$where = [];
		$where['md.stereotype'] = 'VERIVALI-KORWIL-REJECTED';
