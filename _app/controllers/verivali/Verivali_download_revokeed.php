...
// show status 9a
class Verivali_download_revoked extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_download_revoked/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI-DOWNLOAD-REVOKED';
		$data['grid']['link_data'] = $this->dir . "get_show_data";
		$data['grid']['table_title'] = 'VERIVALI-DOWNLOAD-REVOKED';
		$data['extra_script'] = '
			<script>
	...
	function get_show_data(){
		...
		$where = [];
		$where['md.stereotype'] = 'VERIVALI-DOWNLOAD-REVOKED';
