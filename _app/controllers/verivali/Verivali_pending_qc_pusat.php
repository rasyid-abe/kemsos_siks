...
// show status 13b
class Verivali_pending_qc_pusat extends Backend_Controller {
	public function __construct() {
		parent::__construct();
		$this->dir = base_url( 'verivali/verivali_survey_revoked/' );
	}
	...
	function show() {
		...
		$data['grid']['title'] = 'VERIVALI-PENDING-QC-PUSAT';
		$data['grid']['link_data'] = $this->dir . "get_show_data");
		$data['grid']['table_title'] = 'VERIVALI-PENDING-QC-PUSAT';
		$data['extra_script'] = '
			<script>
	...
	function get_show_data(){
		...
		$where = [];
		$where['md.stereotype'] = 'VERIVALI-PENDING-QC-PUSAT';
